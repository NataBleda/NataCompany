...
function check_login($conn)
{
    ...
    // Return some default value or handle the case where $_SESSION['name'] is not set
    return null;
}
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="moroccco.jpg" alt="Paris" width="400" height="300">
  ...
  <div class="row">
    ...
    <div class="col-sm-7">
      <form id="contactForm" action="mail.php" method="post">
        ...
        <div class="form-group">
          <button type="submit" name="send" class="btn btn-primary" id="contact-submit">Submit Now</button>
        </div>
      </form>
    </div>
  </div>
